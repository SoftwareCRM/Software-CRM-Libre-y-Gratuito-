...
if (isset($_POST['nom_prd'])){
  if ($_POST["iva_prd"] == 1) {
    $insertar = $objProducto->ModificarProductosAdminSinStock($_POST['id_prod'], $_POST['nom_prd'],$_POST['pre_prd'],$_POST['can_prd'], $iva);  
  } else {
    $insertar = $objProducto->ModificarProductosAdminSinStock($_POST['id_prod'], $_POST['nom_prd'],$_POST['pre_prd'],$_POST['can_prd'], 0);    
  }
}
