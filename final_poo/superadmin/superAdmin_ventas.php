...
if (isset($_GET['fecha1'])) {
  $insertar = $objCompras->EliminarCompraSuperAdmin($_GET['fecha1']);    
}

if (isset($_POST['buscar'])){
  if($_POST['busqueda']){
    $insertar = $objCompras->BuscadorSuperAdmin($_POST['busqueda']);
  }
}
...
<div class="border"> 
        ...
        <div class="pb-3">
          <form class="d-flex pe-1 " method="post"> <!-- BUSCADOR -->
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" placeholder="Buscar por el nombre del operador o del cliente" name="busqueda" aria-describedby="button-addon2" onkeypress="return Direccion(event);" onpaste="return false">
        ...
        <table class="table table-hover">
          ...
          <tbody> 
            ...
            <?php $compras = $objCompras->MostrarCajaSuperAdmin(); 
            ...
            <form action="" method="get"> <!-- FORMULARIO PDF -->
              ...
              <tr>
                ...
                <td class="col-1">
                  ...
                  <a href="./superAdmin_ventas.php?fecha1=<?php echo $fecha;?>" type="submit" class="btn btn-sm factura"><i class="fa-solid fa-trash-can fa-lg" style="color:red;"></i></a>
                  </div>
                </td>
              </tr> 
            </form> <!-- FORMULARIO PDF -->
