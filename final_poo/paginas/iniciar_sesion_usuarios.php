                            ...
                            <form action="" method="POST" class="needs-validation" enctype="multipart/form-data" novalidate> <!--method="POST"-->
                                <div class="input-group mb-3 position-relative">
                                    ...
                                    <label for="usuario" class="form-label m-0 p-0"><b>Usuario</b></label>
                                        <input type="text" class="form-control" placeholder="Nombre de usuario" aria-describedby="addon-wrapping" id="usuario" name="usuario" onkeypress="return Direccion(event);" onpaste="return false" minlength="3" maxlength="40" required>
                                ...
                                <div class="input-group mb-3 position-relative">
                                    ...
                                    <label for="contrasenna" class="form-label m-0 p-0"><b>Contraseña</b></label>
                                        <input type="password" class="form-control" placeholder="Contraseña" aria-describedby="basic-addon1" name="contrasenna" id="contrasenna" onkeypress="return Direccion(event);" onpaste="return false" minlength="3" maxlength="40" required>
                                        <div class="invalid-tooltip">
                                ...
                                <h5 class="py-3 pb-0 text-center">¿No tienes una cuenta?<br><a href="./registrar_usuarios.php">Crear cuenta</a></h5>
                            </form>
                        </div>
                        <div class="col-2 col-sm-0"></div>
                    </div>
